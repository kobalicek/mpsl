...
const InstInfo mpInstInfo[kInstCodeCount] = {
  ...
  ROW(Slli      , "slli"        , 3, I(I32)                       | I(Imm)),
  ROW(Srli      , "srli"        , 3, I(I32)                       | I(Imm)),
  ROW(Srai      , "srai"        , 3, I(I32)                       | I(Imm)),
  ...
  ROW(Shuf      , "shuf"        , 3, I(I32) | I(F32) | I(F64)     | I(Imm)),
  ...
  ROW(Vsllw     , "vsllw"       , 3, I(I32)                       | I(Imm)),
  ROW(Vsrlw     , "vsrlw"       , 3, I(I32)                       | I(Imm)),
  ROW(Vsraw     , "vsraw"       , 3, I(I32)                       | I(Imm)),
  ROW(Vslld     , "vslld"       , 3, I(I32)                       | I(Imm)),
  ROW(Vsrld     , "vsrld"       , 3, I(I32)                       | I(Imm)),
  ROW(Vsrad     , "vsrad"       , 3, I(I32)                       | I(Imm)),
  ROW(Vsllq     , "vsllq"       , 3, I(I32)                       | I(Imm)),
  ROW(Vsrlq     , "vsrlq"       , 3, I(I32)                       | I(Imm)),
